...
class App extends Component {
  ...
  onClickCalculateAge = () => {
    ...
    if (m < 0 || (m === 0 && todayDate.getDate() < dateBirth.getDate())) {
      this.setState({
        years: todayDate.getFullYear() - dateBirth.getFullYear() - 1,
      });
    } else {
      this.setState({
        years: todayDate.getFullYear() - dateBirth.getFullYear(),
      });
    }
  };
    ...
    return (
      <div className="age-container">
        ...
        <input
          ...
          value={date}
        />
        <button className="calculate-age" onClick={this.onClickCalculateAge}>
          Caculate Age
        </button>
